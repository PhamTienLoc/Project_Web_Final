...
<body class="d-flex flex-column min-vh-100">
	<main class="form-forgotPass">
		<div class="form-wrapper">
			<h3 class="fs-5 fw-bold py-3 border-bottom">Chọn mật khẩu mới</h3>
			<p class="fs-6 m-0">Tạo mật khẩu mới có tối thiểu 6 ký tự. Mật
				khẩu mạnh là mật khẩu được kết hợp từ các ký tự, số và dấu câu.</p>
			<form action="${pageContext.request.contextPath}/recoverPassword"
				...
				<div class="text-end">
					<a href="${pageContext.request.contextPath}/home"
						class="btn btn-secondary text-decoration-none">Bỏ qua</a>
